...
const HCP_ENGLISH = Object.freeze({
  ...
  "Quantos usuários utilizarão o HCP?": "How many users will use HCP?",
  ...
  "Informe a origem da lista, o nicho, telefone e tamanho da equipe.": "Provide the list source, niche, phone, and team size.",
